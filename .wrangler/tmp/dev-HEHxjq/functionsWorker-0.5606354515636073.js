...
// .wrangler/tmp/pages-y5HhxP/functionsWorker-0.5606354515636073.mjs
...
__name(ensureItinerariesTable, "ensureItinerariesTable");
__name2(ensureItinerariesTable, "ensureItinerariesTable");
async function onRequestPost3({ request, env }) {
  try {
    ...
    ).bind(userId, title, JSON.stringify(itinerary)).run();
    const responseBody = {
      ok: true,
      id: result?.meta?.last_row_id ?? null
    };
...
// .wrangler/tmp/bundle-0XW3OA/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-0XW3OA/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5606354515636073.js.map
